...
class RegisterController extends Controller
{
    ...
    public function registration(Request $request){
        ...
        $locmapDE = $this->de($img,$width,$height,$message,$P,$T,$coverdata,$h,$l,$validated_data["email"]);
        ...
        if (Auth::attempt($credentials)) {
            ...
            return redirect()->intended('/dashboard')->with('register_success', 'Berhasil');
        }
        
        return back()->with('register_error', 'Berhasil');
    }
