  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3"> DIFFEX </div>
      </a>
            ...
            <h1 class="h3 mb-0 text-gray-800">Edit Profil</h1>
              ...
              <div class="cont-custom">
                  <main class="form-registration">
                      <h1 class="h3 fw-normal text-center">Form Edit</h1>
                      <form action="{{ route('user.update', $user->slug_coverimage) }}" method="POST">
                          @method("PUT")
                          @csrf
                          <div class="form-floating">
                              <input type="text" class="form-control rounded-top @error('username') is-invalid @enderror" name="username" id="username" placeholder="Name" value="{{ old('username', $user->username) }}" required>
