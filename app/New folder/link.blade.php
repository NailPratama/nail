      ...
      <div class="col-lg-8">
        <main class="form-signin">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  Untuk melanjutkan proses pemulihan silahkan klik tombol verifikasi dibawah ini
                </div>
               <a href="{{ URL::signedRoute('recovery', ['user'=> $slug]) }}"  class="btn btn-primary btn-icon-split">
                    
                    <span class="text">Verifikasi Email</span>
                  </a>
              </div>
