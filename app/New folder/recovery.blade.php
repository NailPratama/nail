          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Perbaharui Akun</h1>
              </div>
             ...
             <form action="{{ route('user.update', $user->slug_coverimage) }}" method="POST">
                ...
                <div class="form-group">
                  <input type="text" class="form-control rounded-top @error('username') is-invalid @enderror" name="username" id="username" placeholder="Username" value="{{ old('username') }}" required>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="card mb-3" style="width: 14rem;">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <p class="text-muted mt-0 fs-6">by {{ $cover->pengunggah }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
